...
tsdata = mssql.rd_sql_ts(server, database, ts_daily_table, 'ExtSiteID', 'DateTime', 'Value', where_in={'ExtSiteID': sites, 'DatasetTypeID': dataset}, from_date=from_date, to_date=to_date)
